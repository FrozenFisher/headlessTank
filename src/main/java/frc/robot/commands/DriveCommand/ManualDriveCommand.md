...
public class ManualDriveCommand extends Command {
  ...
  public ManualDriveCommand(CommandXboxController controller, TankSubsystemOLD driveControl) {
  ...
  private void headlessMove() {
    ...
    if (stickVector.getNorm() > TankConstants.K_DEADBAND) {
      ...
      double stickAngle = stickVector.getAngle().getDegrees();
  ...
  private void headlessTurn() {
    ...
    if (leftStickVector.getNorm() > TankConstants.K_DEADBAND) {
      targetAngle = leftStickVector.getAngle().getDegrees();
      hasValidInput = true;
      isLeftStickInput = true;
    } else if (rightStickVector.getNorm() > TankConstants.K_DEADBAND) {
      targetAngle = rightStickVector.getAngle().getDegrees();
      hasValidInput = true;
